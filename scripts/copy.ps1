...
$fileName = $qpmJson.info.additionalData.overrideSoName

if ($useDebug -eq $true) {
    & adb push build/debug/$fileName /sdcard/ModData/com.beatgames.beatsaber/Modloader/shims/$fileName
} else {
    & adb push build/$fileName /sdcard/ModData/com.beatgames.beatsaber/Modloader/shims/$fileName
}
